...
int main(int argc, char** argv) {
    ...
    ptr=strchr(texto,'s'); // caso seja alterado a letra, o programa vai procurar pela letra escolhida dentro da frase
    
    if (*ptr){
        cout << "A letra s apareceu pela primeira vez na posicao: " << ptr-texto+1 << endl;
    }
    else {
